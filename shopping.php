...
<div><br><br></div>
  <div class="container marketing" style="width: 60%;
    ...
    <?php  
  $query2 = mysqli_query($conn, "SELECT * FROM shopping");
  while($result2 = mysqli_fetch_array($query2)){
?>

    <div class="row featurette">
      <div style="text-align: center;">
        <h2 class="featurette-heading" ><?php echo $result2["heading"]?><span class="text-muted"></span></h2><br>
        <div>
        <img src="<?php echo $result2["img"]?>" style="width: 500px; height:300px;">
        </div><br>
        <p class="lead" style="text-align: center; color:grey;"><?php echo $result2["contents"]?></p>
      </div>
    </div>
    <hr class="featurette-divider">

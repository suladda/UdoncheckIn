...
?>
    ...
    <div class="row featurette">
      <div style="text-align: center;">
        <h2 class="featurette-heading" ><?php echo $result["heading"]?><span class="text-muted"></span></h2><br>
        <div>
        <img src="<?php echo $result["img"]?>" style="width: 500px; height:300px;">
        </div><br>
        <p class="lead" style="text-align: center; color:grey;"><?php echo $result["contents"]?></p>
      </div>
    </div>
    <hr class="featurette-divider">

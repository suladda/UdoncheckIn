...
<form action="write_db.php" method="post">
 <div class="form-group">
    <h3 style="color: green">เขียนเรื่องราวของคุณที่นี้</h3><br>
    <label for="contents" style="color: red; font-size: 16px">หัวข้อ</label> 
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="heading"></textarea>
    <label for="contents" style="color: red; font-size: 16px">เนื้อหา</label> 
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="datacontents"></textarea>
